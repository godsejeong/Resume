...
**Android(Java,Kotlin)** : MVVM아키텍처 적용 및 실무 애플리케이션 제작 및 유지보수 경험이 있습니다.
...
- 기간 : 2018.10~11
- Webview Bridge를 이용한 웹연동 및 ViroARcore를 통해 유연한 AR뷰어 개발,CustomCamera,OpenCV를 이용해 사진등록 및 이미지크롭기능을 개발하였습니다. ARcore 같은 경우 향후 유지보수를 생각하여 GoogleARcore보다 훨씬 많은 기능을 제공하는 ViroARcore를 사용하였고 사용자의 편의성을 고려하여 이미지크롭라이브러리 대신 OpenCV를 이용하여 개발하였습니다.
...
향후 유지보수를 신경써 MVVM아키텍처와 의존성을 주입하여 프로젝트 설계를 하였습니다. 기능적인 면으로는 뷰에 따른 제스처 에니메이션을 구현해 앱의 UX를 신경쓰고, 커스텀 캘린더뷰를 구현해 태그기능을 제작하였습니다.\n 또한 사용자 테마에 맞는 Theme을 설정하여 실시간으로 갱신 하였습니다.
- 사용기술
...
- [개인] Chatting : Soket을 사용하기위해 만든 채팅 애플리케이션입니다.
