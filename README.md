...
맡겨진 업무에 항상 최선을 다해 노력하는 개발자, 멋진 동료들과 소통하고 협업해 완벽한 서비스를 만들 수 있도록 노력하는 개발자, 나재민입니다. 
캐릭터 챗봇 브랜드 '헬로우봇'을 개발하는 [Thingsflow](https://www.wanted.co.kr/company/1856)에 Android 개발자로 재직 중 입니다. 
헬로우봇 신규 피쳐와 유지보수를 맡아 개발하고 있습니다.

안드로이드 아키텍처 패턴과 AAC에 관심이 있으며, 새로운 기술을 도입하는것을 좋아합니다.

- 이름 : 나재민
- E-mail : dbdnpxm@gmail.com
- Github : https://github.com/jjmins
- 취미 : 조주(칵테일) 및 테이스팅, 피아노, 여행, 스터디, 사이드 프로젝트
...
여러 팀 프로젝트를 통해 협업과 커뮤니케이션 기술을 습득하였습니다.
실무 앱 제작 및 협업, 유지보수 경험이 있습니다.

<br>

**Android (4년)**   ◼︎◼︎◼︎◼︎◻︎

> Java, Kotlin을 이용해 개발을 하고 있습니다. <br>
> 주로 MVVM에 aac를 활용하여 개발을 진행하고 있습니다. <br>
> 협업과 커뮤니케이션을 위해 옳바른 아키텍처 선택과 기술선택에 중점을 두고 있고 Clean Code를 지향합니다.
...
**Flask**   ◼︎◻︎◻︎◻︎◻︎
  - 간단한 Api제작, 세션관리 기능을 개발한 경험이 있습니다.
...
(주)런잇 모바일 앱 개발자(Android, flutter) 개발자 (2020.02 ~ 2020.05)

(주)띵스플로우 안드로이드 개발자 (2020.10 ~)
...
- **2019 선린인터넷고등학교 선린톤** 동상
- **2019 서울시 창의아이디어 경진대회** 대상
- **2019 선린인터넷고등학교 모바일 콘텐츠 경진대회** 금상
- **2019 선린인터넷고등학교 창의아이디어 경진대회** 금상
- **앱잼 14회 생활부문** 장려상
- **앱잼 17회 생활부문** 장려상
...
**개인프로젝트**
 - MVC,MVP,MVVM ACC등의 아키텍처 패턴,Di(Koin),Rxjava등을 활용해 프로젝트 개발
...
- 기간 : 2018.10 ~ 11
- WebView Bridge를 이용한 웹 연동 및 ViroARcore를 통해 유연한 AR 뷰어 개발, CustomCamera, OpenCV를 이용해 사진등록 및 이미지 크롭 기능을 개발하였습니다. ARcore 같은 경우 향후 유지보수를 생각하여 GoogleARcore보다 훨씬 많은 기능을 제공하는 ViroARcore를 사용하였고 사용자의 편의성을 고려하여 이미지 크롭 라이브러리 대신 OpenCV 라이브러리를 개조하여 개발하였습니다. 
