...
향후 유지보수를 신경써 MVVM아키텍처와 의존성을 주입하여 프로젝트 설계를 하였습니다. 

기능적인 면으로는 뷰에 따른 제스처 에니메이션을 구현해 앱의 UX를 신경쓰고, 커스텀 캘린더뷰를 구현해 태그기능을 제작하였습니다. 또한 사용자 테마에 맞는 Theme을 설정하여 실시간으로 갱신 하였습니다.
- 사용기술
